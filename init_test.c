...
extern void sig(double *theta, double *x, double *y, double *z, double *weights, double *Tq,  double *V,double *W, float *quantile,  int *p, int *q, int *m, int *M, int *N, int *Kq, int *start, int *end, double *sigma) ;
extern void lamC_ll_h(double theta[], double *x, double *y, double *z, double *weights, double *lambda,double *Tq, double *V, double *W, double *sigma, float *quantile, int *p, int *q, int *m, int *M, int *N, int *Kq, int *start, int *end, double *loglik) ;
extern void invlamC_ll_h(double theta[], double *x, double *y, double *z, double *weights, double *lambda,double *Tq, double *V, double *W, double *sigma, float *quantile, int *p, int *q, int *m, int *M, int *N, int *Kq, int *start, int *end, double *loglik) ;
...
static const R_CMethodDef CEntries[] = {
    ...
    {"sig",       (DL_FUNC) &sig,       18},
    {"lamC_ll_h",       (DL_FUNC) &lamC_ll_h,       20},
    {"invlamC_ll_h",       (DL_FUNC) &lamC_ll_h,       20},
    {NULL, NULL, 0}
};
